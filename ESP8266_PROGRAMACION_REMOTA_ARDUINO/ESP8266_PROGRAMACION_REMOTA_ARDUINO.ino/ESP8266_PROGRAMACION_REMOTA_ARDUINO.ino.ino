...
#define AP_NORMAL "ONO8A95"
#define PWD_NORMAL "pauladelavega5"
#define HOST_NORMAL "192.168.1.140" //ip del PC host
#define PORT_NORMAL "49000"
 
#define AP_BOOTLOADER "ONO8A95"
#define PWD_BOOTLOADER "pauladelavega5"
#define HOST_BOOTLOADER "192.168.1.140" //ip del host
